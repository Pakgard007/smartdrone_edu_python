        ...
        while (True):
            try :
                ...
                if minput == '1':
                    ...
                    with fly.sync_these():
                        fly.jump_between_pads( x=100, y=0, z=mz, speed=40, yaw=0, pad1='m1', pad2='m2',tello=1)

                    with fly.sync_these():
                        fly.reorient(height=mz, pad='m2', tello=1)

                    with fly.sync_these():
                        fly.jump_between_pads( x=100, y=100, z=mz, speed=40, yaw=0, pad1='m2', pad2='m4',tello=1)
                    ...
                    with fly.sync_these():
                        fly.jump_between_pads( x=0, y=100, z=mz, speed=40, yaw=0, pad1='m4', pad2='m3',tello=1)
                    ...
                    with fly.sync_these():
                        fly.jump_between_pads( x=0, y=100, z=mz, speed=40, yaw=0, pad1='m3', pad2='m2',tello=1)
                       
                    with fly.sync_these():
                        fly.reorient(height=mz, pad='m2', tello=1)

                    with fly.sync_these():
                        fly.jump_between_pads( x=0, y=100, z=mz, speed=40, yaw=0, pad1='m2', pad2='m1',tello=1)
