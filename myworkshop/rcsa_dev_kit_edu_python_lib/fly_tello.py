...
class FlyTello:
    ...
    def high(self, height: int, speed: int, tello: Union[int, str]='All', sync: bool=True) -> None:
        
        self._control_multi(command='go',
                            val_params=[(height, 0, 500, 'height'),
                                        (speed, 10, 100, 'speed')],
                            opt_params=[], tello_num=tello, sync=sync)
    ...
    def curve_from_pad(self, x1: int, y1: int, z1: int, x2: int, y2: int, z2: int, speed: int, pad1: str,pad2: str,
                       tello: Union[int, str]='All', sync: bool=True) -> None:
    ...
    def bounceleft(self, dist: int,times: int, tello: Union[int, str]='All', sync: bool=True) -> None:
    ...
    def bounceright(self, dist: int,times: int, tello: Union[int, str]='All', sync: bool=True) -> None:
    ...
    def bouncebbb(self, dist: int,times: int, tello: Union[int, str]='All', sync: bool=True) -> None:
    ...
    def MMMspiral(self, dist: int, spirals: int, height: int, speed: int,  tello: int) -> bool:
        """ Shortcut method to perform a spiral search around the starting point, returning True when found.
